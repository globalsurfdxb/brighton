...
export default function SliderNavBtn({
  ...
  return (
    <button
      ...
      className="btn-fill-center cursor-pointer group select-none flex items-center justify-center max-h-[42px] py-2 px-5 lg:px-[29px] rounded-[50px] border border-secondary  disabled:opacity-40 disabled:cursor-not-allowed"
    >
      <Image
