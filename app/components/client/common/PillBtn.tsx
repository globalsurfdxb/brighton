...
export default function PillBtn({
  ...
  return (
    <button
      ...
      className={`btn-fill-center rounded-full border border-secondary px-4.5 md:px-5 py-[15.5] text-15 font-itc-medium leading-none transition-colors duration-500 max-h-9.25 md:max-h-10.5 flex items-center justify-center uppercase cursor-pointer group ${
        active
