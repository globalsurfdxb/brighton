  ...
  return (
    <section className="w-full py-100">
      <div className="container">
        <div className="flex flex-col lg:flex-row justify-between gap-100 min-[1900px]:gap-[110px] items-center">
          {/* Left */}
          <div className="w-full lg:w-1/2 flex flex-col flex-1">
            <AnimatedTitle text={serviceDrivenData.title} className="section-title mb-30 max-w-[13ch]" />
