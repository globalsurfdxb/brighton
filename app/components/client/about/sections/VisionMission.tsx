  ...
  return (
    <section className="container max-h-[620px]">
        <div className="relative w-full max-w-[1920px] mx-auto p-0 rounded-[10px] overflow-hidden">
          ...
          />
          {/* Right panel */}
          <div className="ml-auto w-[49.3%] max-w-[897px] flex flex-col z-10">
            {visionMissionData.items.map((item, i) => (
              <div
                key={i}
                className="flex-1 p-80 3xl:py-[84px] 3xl:px-[89px] border border-secondary rounded-[10px] -mb-px relative overflow-hidden"
              >
                <div className="absolute inset-0 bg-black/60 rounded-[10px]" />
