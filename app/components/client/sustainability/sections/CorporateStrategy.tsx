    ...
    <section className="w-full">
      <div className="container">
        <div className="bg-cream-background rounded-[10px] overflow-hidden grid grid-cols-1 lg:grid-cols-2 3xl:grid-cols-[1fr_909px]">
          {/* Left */}
          <div className="flex flex-col justify-center px-60 py-150 3xl:py-[197px] pr-80">
          ...
          {/* Right */}
          <div className="relative w-full min-h-[280px] lg:min-h-0 rounded-[10px] overflow-hidden">
            <Image
              src={image}
              alt={imageAlt}
              fill
