...
export const SharePill = ({ title }: { title: string }) => {
  ...
  return (
    <div className="xl:mb-40 inline-flex w-fit items-center rounded-full border border-secondary pr-2.5 pl-5 3xl:pl-7.5 py-2">
      <span className="text-subtitle-2 uppercase text-description-color text-trim">
        Share
      </span>
